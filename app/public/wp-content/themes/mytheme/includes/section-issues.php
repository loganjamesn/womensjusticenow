<div class="issues-grid">
	...
	if ( $parent->have_posts() ) : ?>
	    <?php while ( $parent->have_posts() ) : $parent->the_post(); ?>
			...
			<div class="single-issue" style="opacity: 1;">
